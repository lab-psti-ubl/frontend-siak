  ...
  if (loading) {
    return (
      <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="px-5 sm:px-6 lg:px-8 py-4 sm:py-5 border-b border-slate-200">
          <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900">Komponen Penilaian</h3>
          <p className="text-xs sm:text-sm text-slate-500 mt-1">Persentase setiap komponen dalam penilaian</p>
        </div>
        <div className="p-5 sm:p-6 lg:p-8">
          <div className="text-center py-8 sm:py-12">
            <p className="text-sm sm:text-base text-slate-500">Memuat komponen penilaian...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="p-5 sm:p-6 lg:p-8">
          <div className="text-center py-8 sm:py-12">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-3">
              <span className="text-xl sm:text-2xl text-slate-400">⚙️</span>
            </div>
            <p className="text-sm sm:text-base font-medium text-slate-600">Belum ada komponen penilaian</p>
            <p className="text-xs sm:text-sm text-slate-500 mt-1">Atur komponen penilaian di pengaturan</p>
          </div>
        </div>
      </div>
    );
