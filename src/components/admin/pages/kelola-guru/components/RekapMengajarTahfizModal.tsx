          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center space-x-3 sm:space-x-4 w-full sm:w-auto">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900">Rekap Mengajar Tahfiz</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 pt-4 border-t border-blue-200">
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0">
                  <span className="text-xs sm:text-sm text-gray-600">Ustadz:</span>
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  <span className="text-xs sm:text-sm text-gray-600 block">Tahun:</span>
                  <select
                    value={selectedYear}
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0">
                  <span className="text-xs sm:text-sm text-gray-600 block">Total Kelas:</span>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
            ...
            <Card className="bg-gradient-to-r from-green-50 to-green-100">
              <div className="text-center">
                ...
                <p className="text-xs sm:text-sm text-gray-600 mt-1">Mengajar</p>
              </div>
            </Card>
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border-t border-gray-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs sm:text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-700">Mengajar</span>
                </div>
                <div className="flex items-center space-x-2">
      ...
      {!rekapData && (
        <Card className="p-8 sm:p-12">
          <div className="text-center text-gray-500">
            ...
            <p className="text-base sm:text-lg font-medium">Tidak ada data rekap mengajar tahfiz</p>
            <p className="text-xs sm:text-sm mt-2 text-gray-600">Pilih tahun untuk melihat rekap mengajar</p>
          </div>
        </Card>
      )}
    </div>
