...
const AdminDashboard: React.FC = () => {
  ...
  const generateRecentActivities = () => {
    ...
    // Add pending izin guru
    if (pendingIzinGuru.length > 0) {
      activities.push({
        id: 'izin-guru-pending',
        title: `${pendingIzinGuru.length} pengajuan izin guru menunggu verifikasi`,
    ...
    if (pendingSuratIzin.length > 0) {
      activities.push({
        ...
        title: `${pendingSuratIzin.length} surat izin murid menunggu verifikasi`,
    ...
    recentGuruAbsen.forEach(absen => {
      ...
      if (guru) {
        activities.push({
          ...
          title: `${guru.name} telah absen masuk`,
          subtitle: `${absen.jamMasuk} - ${absen.statusMasuk === 'tepat_waktu' ? 'Tepat waktu' : 'Terlambat'}`,
          time: 'Hari ini',
    ...
    if (activeTahunAjaran) {
      activities.push({
        ...
        title: `Tahun ajaran ${activeTahunAjaran.tahun} aktif`,
        subtitle: `Semester ${activeTahunAjaran.semester} (${activeTahunAjaran.semester === 1 ? 'Ganjil' : 'Genap'})`,
        time: 'Sistem',
        type: 'info' as const,
        icon: Calendar,
      });
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 text-white">
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2">Selamat Datang, Admin!</h1>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center">
              ...
              <span className="text-sm sm:text-base lg:text-xl">Menunggu Persetujuan</span>
            </h3>
            
            {(pendingIzinGuru.length > 0 || pendingSuratIzin.length > 0) ? (
              <div className="space-y-3 sm:space-y-4">
                {pendingIzinGuru.length > 0 && (
                  <div 
                  ...
                  >
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      <div className="flex items-center min-w-0 flex-1">
                        ...
                        <span className="font-medium text-yellow-900 text-sm sm:text-base truncate">Izin Guru</span>
                      </div>
                      <Badge variant="warning" className="flex-shrink-0 ml-2 text-xs">{pendingIzinGuru.length} pending</Badge>
                    </div>
                  ...
                  <div className="p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg sm:rounded-xl border border-blue-200">
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      <div className="flex items-center min-w-0 flex-1">
                        ...
                        <span className="font-medium text-blue-900 text-sm sm:text-base truncate">Surat Izin Murid</span>
                      </div>
                      <Badge variant="info" className="flex-shrink-0 ml-2 text-xs">{pendingSuratIzin.length} pending</Badge>
                    </div>
                    <div className="space-y-2 max-h-32 overflow-y-auto">
                      ...
                      {pendingSuratIzin.length > 3 && (
                        <p className="text-xs text-gray-500">
                          +{pendingSuratIzin.length - 3} lainnya
                        </p>
                      )}
                    </div>
                    <p className="text-xs text-blue-600 mt-2">
                      Perlu ditinjau oleh wali kelas masing-masing
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="text-center py-6 sm:py-8">
                ...
                <h4 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Semua Terverifikasi</h4>
                <p className="text-sm sm:text-base text-gray-600">Tidak ada pengajuan yang menunggu persetujuan</p>
              </div>
            )}
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center">
              ...
              <span className="text-sm sm:text-base lg:text-xl">Aktivitas Terbaru</span>
            </h3>
            <div className="space-y-2 sm:space-y-3">
              {recentActivities.length > 0 ? (
                ...
                <div className="text-center py-6 sm:py-8">
                  <CheckCircle className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 text-emerald-300" />
                  <h4 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Semua Berjalan Lancar</h4>
                  <p className="text-sm sm:text-base text-gray-600">Tidak ada aktivitas yang memerlukan perhatian khusus</p>
                </div>
              )}
            </div>
          </div>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center">
              ...
              <span className="text-sm sm:text-base lg:text-xl">Status Sistem</span>
            </h3>
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg sm:rounded-xl">
                <div className="flex items-center min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-blue-900 text-sm sm:text-base truncate">Tingkat Kehadiran Guru</p>
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg sm:rounded-xl">
                <div className="flex items-center min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-purple-900 text-sm sm:text-base truncate">Jadwal Aktif</p>
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg sm:rounded-xl">
                <div className="flex items-center min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-orange-900 text-sm sm:text-base truncate">Pengaturan Absen</p>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center">
              ...
              <span className="text-sm sm:text-base lg:text-xl">Aksi Cepat</span>
            </h3>
            <div className="space-y-2 sm:space-y-3">
              <Button 
                fullWidth 
              ...
              >
                <div className="flex items-center w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-gray-900 text-xs sm:text-sm lg:text-base">Kelola Guru</p>
                    <p className="text-xs text-gray-500 truncate">Tambah & edit data guru</p>
                  </div>
              ...
              >
                <div className="flex items-center w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-gray-900 text-xs sm:text-sm lg:text-base">Kelola Murid</p>
                    <p className="text-xs text-gray-500 truncate">Tambah & edit data murid</p>
                  </div>
              ...
              >
                <div className="flex items-center w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-gray-900 text-xs sm:text-sm lg:text-base">Jadwal Pelajaran</p>
                    <p className="text-xs text-gray-500 truncate">Atur jadwal mengajar</p>
                  </div>
              ...
              >
                <div className="flex items-center w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-gray-900 text-xs sm:text-sm lg:text-base">QR Admin</p>
                    <p className="text-xs text-gray-500 truncate">Pantau absen guru</p>
                  </div>
              ...
              >
                <div className="flex items-center w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-gray-900 text-xs sm:text-sm lg:text-base">Monitoring Kelas</p>
                    <p className="text-xs text-gray-500 truncate">Monitor guru mengajar real-time</p>
                  </div>
      ...
      <Card className="border-0 shadow-lg">
        <div className="p-4 sm:p-6">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center">
            ...
            <span className="text-sm sm:text-base lg:text-xl">Ringkasan Akademik</span>
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            <div 
            ...
            >
              ...
              <p className="text-xs text-blue-700">Jadwal Aktif</p>
            </div>
            ...
            >
              ...
              <p className="text-xs text-emerald-700">Wali Kelas</p>
            </div>
            ...
            >
              ...
              <p className="text-xs text-purple-700">Kelas Aktif</p>
            </div>
            ...
            >
              ...
              <p className="text-xs text-orange-700">Sesi Aktif</p>
            </div>
          </div>
        </div>
      </Card>
        ...
        <div className="p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 flex items-center">
              ...
              <span className="text-sm sm:text-base lg:text-xl">Ringkasan Hari Ini</span>
            </h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
            <div className="p-3 sm:p-4 bg-blue-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm text-blue-600">Guru Mengajar</p>
            ...
            <div className="p-3 sm:p-4 bg-emerald-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm text-emerald-600">Sesi Absensi</p>
                  <p className="text-xl sm:text-2xl font-bold text-emerald-900">{todaySessions.length}</p>
                  <p className="text-xs text-emerald-700 truncate">
                    {activeSessions.length} sesi masih aktif
                  </p>
                </div>
            ...
            <div className="p-3 sm:p-4 bg-purple-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm text-purple-600">Pengajuan Pending</p>
                  <p className="text-xl sm:text-2xl font-bold text-purple-900">
                    {pendingIzinGuru.length + pendingSuratIzin.length}
                  </p>
                  <p className="text-xs text-purple-700 truncate">
                    {pendingIzinGuru.length} izin guru, {pendingSuratIzin.length} izin murid
                  </p>
                </div>
